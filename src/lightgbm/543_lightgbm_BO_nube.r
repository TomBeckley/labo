...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower=  1000    , upper= 6000),
         makeIntegerParam("min_sum_hessian_in_leaf", lower=  1000    , upper= 6000),
         ...
         makeNumericParam("max_depth",        lower=  0    , upper=   9),
         makeNumericParam("num_iterations",   lower=  0    , upper=   2500),
         makeNumericParam("bagging_fraction", lower=  0.01    , upper= 1),
         makeNumericParam("bagging_freq",     lower=  0    , upper= 1)
         
        )

ksemilla_azar  <- 200003  #Aqui poner la propia semilla
...
dir.create( "./exp/HT5380/", showWarnings = FALSE )
setwd("./exp/HT5380/")   #Establezco el Working Directory DEL EXPERIMENTO


#en estos archivos quedan los resultados
kbayesiana  <- "HT538.RDATA"
klog        <- "HT538.txt"
