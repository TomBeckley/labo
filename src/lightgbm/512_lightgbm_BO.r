...
setwd("D:\\Tom\\MASTER\\DATA SCIENCE\\")   #Establezco el Working Directory
...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   max_bin=             31,
                                   learning_rate=        0.0200857211036409,
                                   num_iterations=      298,
                                   num_leaves=          353,
                                   feature_fraction=     0.300868003321114,
                                   min_data_in_leaf=  2591,
                                   seed=            999983 )  )
